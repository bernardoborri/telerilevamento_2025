...
# Abbiamo visto che quando usiamo la funzione “im.import” per un’immagine, imageRy la fa comparire automaticamente
# Invece con il comando “flip” è necessario poi aggiungere dopo il comando “plot” per far apparire l’immagine capovolta
# Facciamo dunque una funzione di “flip intelligente” e la chiamiamo “flipint”:
flipint <- function(x) {
x = flip(x)
plot(x)
}
# Questa funzione dice che “flipint”, presa l’immagine “x”, applicherà un flip di “x” e ne produrrà il plot in modo immediatamente consecutivo
